...
const CartEmpty = () => {
  return (
    <div className="w-full h-[80vh] container mx-auto flex justify-center items-center my-4 px-4 py-4 ">
      <div class="empty-cartch-[20vh]">
        <svg
          className="h-[30vh] items-center justify-center container"
        ...
        <span className="justify-center text-center w-full mx-auto text-xl">
          <h1>Your cart is empty !</h1>
        </span>
        <Link to="/">
          <span className=" flex justify-center items-center pr-4 text-center w-full mx-auto ">
            <button className="text-center   block mt-4   bg-indigo-500 rounded-md py-2 px-4 font-semibold text-lg  text-white transition-all duration-500 hover:bg-indigo-700">
              Go to Home
            </button>
          </span>
        </Link>
