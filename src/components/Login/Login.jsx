              ...
              <form>
                  ...
                  <p class="text-sm mt-4 ">
                    ...
                    <Link to="/signup">
                      <a
                        ...
                        class="text-teal-400 font-semibold hover:underline ml-1 whitespace-nowrap"
                      >
                        Sign Up
                      </a>
                    </Link>
                ...
                <div class="flex items-center justify-between gap-2 mt-5">
                  <div class="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      class="h-4 w-4 shrink-0 text-teal-600 focus:ring-teal-500 border-gray-300 rounded"
                    />
                ...
                <div class="mt-12">
                  <button
                    ...
                    type="button"
                    class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded-full text-white bg-teal-400 hover:bg-teal-500 focus:outline-none"
                  >
                    Sign in
                  </button>
                </div>
